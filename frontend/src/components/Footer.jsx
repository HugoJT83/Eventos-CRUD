  ...
  return (
    <>
      <footer className="text-gray-600 body-font">
        <div className="container text-terciary px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <a className="ml-3 text-terciary" href='www.linkedin.com/in/hugo-jariod-tomás-15a39b3b2'>
